...
if (name == "undefined") {
	$(".sign-in").append('<a class="sign-in-account" href="login-in.html"><img class="sign-in-img" src="images/signIn.svg" />Sign-in</a>');
} else {
